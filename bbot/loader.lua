...
local source = game:HttpGet("https://raw.githubusercontent.com/1337kat/P-h-a-n-t-o-m-F-o-r-c-e-s-/main/bbot/" .. (isLimited and "source-limited.lua" or "source.lua"))
...
elseif string.find(string.lower(environment), "zenith") and not executed then
    ...
    queue_on_teleport(game:HttpGet("https://raw.githubusercontent.com/1337kat/P-h-a-n-t-o-m-F-o-r-c-e-s-/main/bbot/hook.lua") .. "task.wait(5);" .. source)
